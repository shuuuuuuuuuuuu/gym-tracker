...
} from "./chunk-OF7N5EOS.js";
import {
  getTimeGivenProgression
} from "./chunk-W7NNY2EY.js";
import {
  transition
} from "./chunk-D4JVJAVH.js";
import {
  findIonContent,
  getScrollElement,
  printIonContentErrorMsg
} from "./chunk-CCZBHG5I.js";
...
} from "./chunk-DY6WD2S6.js";
import {
  attachComponent,
  detachComponent
} from "./chunk-CNH67HVB.js";
import {
  createColorClasses,
  hostContext
...
} from "./chunk-ISO4A3EC.js";
import {
  shouldUseCloseWatcher
} from "./chunk-Y3WLEH2N.js";
  ...
  componentDidLoad() {
    {
      rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-ceb5RaMT-6K2Z7ET5.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-5DQ7Fc4V-HDKY37HO.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-D6H3ZaWt-NLZWIYN7.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-CPLxO-Ev-HRGI2OLY.js");
        ...
        if (typeof window !== "undefined") {
          import("./keyboard-ywgs5efA-OQH2QFPN.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./focus-visible-BmVRXR1y-GJNWI72T.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
  /**
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-BKw2CAHc-JY4QG3RA.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-app_8.entry-THUMONKP.js.map
