...
function Tab2Page_ion_button_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ion-button", 1);
    \u0275\u0275listener("click", function Tab2Page_ion_button_18_Template_ion_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.changePeriod("next"));
    });
...
var _Tab2Page = class _Tab2Page {
  constructor(workoutService, router) {
    ...
    this.totalVolume = 0;
    this.avgIntensity = 0;
    this.maxIntensityPercent = 0;
  }
  ionViewWillEnter() {
    this.currentDate = this.normalizeDate(/* @__PURE__ */ new Date());
    this.loadStatsData();
  }
  ngOnInit() {
  }
  ...
  calculateVolume(w) {
    if (w.unit === "reps" && w.weight !== null)
      return w.weight * w.value * w.sets;
    if (w.unit === "secs")
      return w.value * w.sets;
    return 0;
  }
  estimate1RM(w) {
    if (w.unit !== "reps" || !w.weight || w.value <= 1)
  ...
  filterWorkoutsByRange() {
    ...
    return this.workouts.filter((w) => {
      ...
      switch (this.timeRange) {
        ...
        case "month":
          return workoutDate.getFullYear() === current.getFullYear() && workoutDate.getMonth() === current.getMonth();
        case "year":
  ...
  recalculate() {
    ...
    const byMuscle = {};
    source.forEach((w) => {
      const muscle = w.primary_muscle ?? "\u672A\u5206\u985E";
  ...
  // 🔹 日期導覽
  get canGoNext() {
    const today = this.normalizeDate(/* @__PURE__ */ new Date());
  ...
  get displayRange() {
    ...
    switch (this.timeRange) {
      ...
      case "week":
        ...
        return `${start.getFullYear()}/${String(start.getMonth() + 1).padStart(2, "0")}/${String(start.getDate()).padStart(2, "0")} ~ ${d.getFullYear()}/${String(d.getMonth() + 1).padStart(2, "0")}/${String(d.getDate()).padStart(2, "0")}`;
      case "month":
...
_Tab2Page.\u0275fac = function Tab2Page_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _Tab2Page)(\u0275\u0275directiveInject(WorkoutService), \u0275\u0275directiveInject(Router));
};
_Tab2Page.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Tab2Page, selectors: [["app-tab2"]], viewQuery: function Tab2Page_Query(rf, ctx) {
  if (rf & 1) {
...
}, decls: 21, vars: 6, consts: [["title", "GYM TRACKER"], ["fill", "clear", 3, "click"], ["name", "person-circle-outline", 1, "person-circle"], [1, "dark-content"], [3, "ngModelChange", "ionChange", "ngModel"], ["value", "day"], ["value", "week"], ["value", "month"], ["value", "year"], [1, "date-nav"], ["name", "chevron-back-outline"], [1, "date-label"], ["fill", "clear", 3, "click", 4, "ngIf"], [1, "chart-wrapper"], ["baseChart", "", 3, "data", "options", "type"], ["name", "chevron-forward-outline"]], template: function Tab2Page_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "app-header", 0)(1, "ion-button", 1);
    \u0275\u0275listener("click", function Tab2Page_Template_ion_button_click_1_listener() {
      return ctx.goProfile();
    });
    \u0275\u0275element(2, "ion-icon", 2);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(3, "ion-content", 3)(4, "ion-segment", 4);
    \u0275\u0275twoWayListener("ngModelChange", function Tab2Page_Template_ion_segment_ngModelChange_4_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.timeRange, $event) || (ctx.timeRange = $event);
      return $event;
    });
    \u0275\u0275listener("ionChange", function Tab2Page_Template_ion_segment_ionChange_4_listener() {
      return ctx.onTimeRangeChange();
    });
    \u0275\u0275elementStart(5, "ion-segment-button", 5);
    \u0275\u0275text(6, "\u65E5");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "ion-segment-button", 6);
    \u0275\u0275text(8, "\u9031");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "ion-segment-button", 7);
    \u0275\u0275text(10, "\u6708");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "ion-segment-button", 8);
    \u0275\u0275text(12, "\u5E74");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "div", 9)(14, "ion-button", 1);
    \u0275\u0275listener("click", function Tab2Page_Template_ion_button_click_14_listener() {
      return ctx.changePeriod("prev");
    });
    ...
    \u0275\u0275text(17);
    \u0275\u0275elementEnd();
    \u0275\u0275template(18, Tab2Page_ion_button_18_Template, 2, 0, "ion-button", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "div", 13);
    \u0275\u0275element(20, "canvas", 14);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx.timeRange);
    \u0275\u0275advance(13);
    \u0275\u0275textInterpolate1(" ", ctx.displayRange, " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.canGoNext);
    \u0275\u0275advance(2);
    \u0275\u0275property("data", ctx.chartData)("options", ctx.chartOptions)("type", "bar");
  }
}, dependencies: [IonicModule, IonButton, IonContent, IonIcon, IonSegment, IonSegmentButton, SelectValueAccessorDirective, CommonModule, NgIf, FormsModule, NgControlStatus, NgModel, AppHeaderComponent, NgChartsModule, BaseChartDirective], styles: ["\n\n.dark-content[_ngcontent-%COMP%] {\n  --background: var(--ion-background-color);\n  color: var(--ion-text-color);\n}\n.date-nav[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 8px 16px;\n  color: #fff;\n}\n.date-label[_ngcontent-%COMP%] {\n  font-size: 16px;\n  font-weight: 600;\n  text-align: center;\n}\n.chart-wrapper[_ngcontent-%COMP%] {\n  padding: 16px;\n}\n/*# sourceMappingURL=tab2.page.css.map */"] });
var Tab2Page = _Tab2Page;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Tab2Page, [{
    type: Component,
    args: [{ selector: "app-tab2", standalone: true, imports: [IonicModule, CommonModule, FormsModule, AppHeaderComponent, NgChartsModule], template: `<app-header title="GYM TRACKER">
...
<ion-content class="dark-content">
  ...
  <!-- \u6642\u9593\u5340\u9593\u5207\u63DB\uFF08\u65E5 / \u9031 / \u6708 / \u5E74\uFF09 -->
  <ion-segment [(ngModel)]="timeRange" (ionChange)="onTimeRangeChange()">
    <ion-segment-button value="day">\u65E5</ion-segment-button>
    <ion-segment-button value="week">\u9031</ion-segment-button>
    <ion-segment-button value="month">\u6708</ion-segment-button>
    <ion-segment-button value="year">\u5E74</ion-segment-button>
  </ion-segment>

  <!-- \u65E5\u671F\u5C0E\u89BD\uFF08\u524D\u4E00\u6BB5 / \u76EE\u524D\u5340\u9593 / \u4E0B\u4E00\u6BB5\uFF09 -->
  <div class="date-nav">
    <ion-button fill="clear" (click)="changePeriod('prev')">
...
`, styles: ["/* src/app/tab2/tab2.page.scss */\n.dark-content {\n  --background: var(--ion-background-color);\n  color: var(--ion-text-color);\n}\n.date-nav {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 8px 16px;\n  color: #fff;\n}\n.date-label {\n  font-size: 16px;\n  font-weight: 600;\n  text-align: center;\n}\n.chart-wrapper {\n  padding: 16px;\n}\n/*# sourceMappingURL=tab2.page.css.map */\n"] }]
  }], () => [{ type: WorkoutService }, { type: Router }], { chart: [{
    type: ViewChild,
    args: [BaseChartDirective]
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Tab2Page, { className: "Tab2Page", filePath: "src/app/tab2/tab2.page.ts", lineNumber: 19 });
})();
export {
  Tab2Page
};
...
lodash-es/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=tab2.page-OXBKPEKX.js.map
